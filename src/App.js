    ...
    <Router history={history}>
      <Switch>
        ...
        <NavSidebar>
          ...
          <Route path='/Universities/edit/:id' exact component={AddArtistForm} />
          ...
          <Route path='/colleges/:id/table/add' exact component={AddDynamicTable} />
          <Route path='/colleges/:id/edit/:tableid' exact component={AddDynamicTable} />
