...
const AddArtistForm = () => {
  ...
  const handleCoverpic = async (e) => {
    try {
      ...
      /v1_1/sinox-technology/image/upload`, formdata)
      console.log(response)
            ...
            <div className='addArtist-personalDetails'>
              <form onSubmit={handlesubmit} method="POST" enctype="multipart/form-data">
                ...
                <div className='addArtist-alignRow'>
                  ...
                  <div className='addArtist-inputFieldDiv'>
                    <label className='addArtist-inputLabel'>University Logo</label>
                    <input
                      type='file'
                      name='logo'
                      onChange={handlelogo}
                ...
                <div className='addArtist-alignRow'>
                  ...
                  <div className='addArtist-inputFieldDiv'>
                    ...
                    <select
                      ...
                      onChange={handleChange}>
                      <option style={{ color: "red" }} value="">{!!universityData?.city ? `~${universityData?.city}~` : "Please Select A City"} </option>
                ...
                <div className='addArtist-alignRow'>
                  ...
                  <div className='addArtist-inputFieldDiv'>
                    ...
                    <select
                      ...
                      defaultValue="Select A Country"
                      onChange={handleChange}>
                      <option value="">{!!universityData?.status ? `~${universityData?.status}~` : "please select current status"}</option>
