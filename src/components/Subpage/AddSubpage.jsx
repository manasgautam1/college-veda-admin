...
import { PostSubpage, PostTestimonial, getBlogById, getSubpagesById, postBlog, updateBlogs, updateSubpages } from '../../redux/api';
            ...
            <div className='addEmployee-alignRow mt-3'>
              ...
              <div className='addEmployee-inputLabel'>
                ...
                <select
                  ...
                  onChange={handleChange}>
                  <option value=""> {!!blogData?.course ? `~${blogData?.course}~` : "Please Select A Course"}</option>
                        ...
                        <div className='addEmployee-alignRow'>
                          <div style={{ marginTop: "20px", width: "100%" }}>
                            ...
                            <ReactQuill
                              ...
                              value={item}
                              theme="snow"
                              onChange={(content, delta, source, editor) => { handleSubpageBody(editor.getHTML(), index) }} />
                          </div>
                        </div>
                      </>
                    )
