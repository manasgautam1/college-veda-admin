...
import { UpdateCollege, getCollegeById, getUniversity, postColleges } from '../../redux/api';
              ...
              <form onSubmit={handlesubmit} method="POST" enctype="multipart/form-data">
                ...
                <div className='addArtist-alignRow'>
                  <div className='addArtist-inputFieldDiv'>
                    ...
                    <label className='addArtist-inputLabel'>College Name <span style={{ color: "red", fontSize: "1.2rem" }}>*</span> </label>
                    <input
                      type='text'
                      required="required"
                      name='fullName'
                  ...
                  <div className='addArtist-inputFieldDiv'>
                    <label className='addArtist-inputLabel'>
                      Select a university  <span style={{ color: "red", fontSize: "1.2rem" }}>*</span>
                    </label>
                    ...
                    <select
                      ...
                      onChange={handleChange}>
                      <option style={{ color: "red" }} value="">Please Select A University</option>
                      {(universityList?.map((university, index) => {
                        return <option value={university?._id} key={index}>{university?.fullName}</option>
                      }))
                      }
                    </select>
                  </div>
                ...
                {
                  !!universityData?.coverpic && <div className='d-flex w-100 justify-content-end mt-2'> <img src={universityData?.coverpic} height={50} width={50} alt="logo" /></div>
                }
                ...
                <div className='addArtist-alignRow'>
                  ...
                  <div className='addArtist-inputFieldDiv'>
                    ...
                    <select
                      ...
                      placeholder='Select A State'
                      onChange={handleChange}>
                      <option style={{ color: "red" }} value=""> {!!universityData?.state ? `~${universityData?.state}~` : `Please Select A State`}</option>
                      {
                        (AllStates?.map((states, index) => {
                          return <option value={states} key={index}>{states}</option>
                        }))
                      }
                    </select>
                  </div>
                  <div className='addArtist-inputFieldDiv'>
                    ...
                    <select
                      ...
                      onChange={handleChange}>
                      <option value="">{!!universityData?.city ? `~${universityData?.city}~` : `Please Select A City`}</option>
                ...
                <div className='addArtist-alignRow'>
                  ...
                  <div className='addArtist-inputFieldDiv'>
                    ...
                    <select
                      ...
                      defaultValue="Select A Country"
                      onChange={handleChange}>
                      <option value="">{!!universityData?.status ? `~${universityData?.status}~` : `Select a Status`}</option>
                ...
                <div className='addArtist-alignRow'>
                  ...
                  <div className='addArtist-inputFieldDiv w-100'>
                    ...
                    <label className='addArtist-inputLabel'>Description <span style={{ color: "red", fontSize: "1.2rem" }}>*</span> </label>
                    {/* <textarea
                      type='text'
                      required="required"
                      name='description'
                    ...
                    <ReactQuill
                      ...
                      value={universityData?.description}
                      theme="snow"
                      onChange={(content, delta, source, editor) => { setuniversityData({ ...universityData, description: editor.getHTML() }) }} />
                  </div>
                </div>
                {
                  !!universityData?.logo && <div className='d-flex w-100 justify-content-end mt-2'> <img src={universityData?.logo} height={50} width={50} alt="logo" /></div>
                }
                ...
                <div className='addArtist-alignRow mt-3 flex-column align-items-start'>
                  ...
                  <div className="mb-5 w-100" controlId="formBasicEmail">
                    ...
                    >
                      <h6>Add Images <span className="text-danger">*</span></h6>
                      <button
                    ...
                    {universityData?.gallery.map((item, index) => {
                      return (
                        <>
                          ...
                          <input type="file" name="" onChange={(e) => handleImages(e, index)} placeholder="Choose Image" />
                          <img src={item} alt="gallery-pic" height={70} width={70} />
                        </>
                      )
                    })
                    }
