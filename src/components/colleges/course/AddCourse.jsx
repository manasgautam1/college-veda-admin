...
import { addCourses, getCollegeById, getUniversity, postColleges } from '../../../redux/api';
              ...
              <form onSubmit={handlesubmit} method="POST" enctype="multipart/form-data">
                ...
                <div className='addArtist-alignRow'>
                  ...
                  <div className='addArtist-inputFieldDiv'>
                    <label className='addArtist-inputLabel'>
                      Select a Course  <span style={{ color: "red", fontSize: "1.2rem" }}>*</span>
                    </label>
                  ...
                  <div className='addArtist-inputFieldDiv'>
                    ...
                    <label className='addArtist-inputLabel'>Fees <span style={{ color: "red", fontSize: "1.2rem" }}>*</span> </label>
                    <input
                      type='text'
                      required
                      name='fee'
                ...
                <div className='addArtist-alignRow'>
                  ...
                  <div className='addArtist-inputFieldDiv'>
                    ...
                    <label className='addArtist-inputLabel'>Specializtion <span style={{ color: "red", fontSize: "1.2rem" }}></span> </label>
                    <input
                      type='text'
                      required
                      name='specialization'
