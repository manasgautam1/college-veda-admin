          ...
          <div className='addEmployee-personalDetails'>
            <div className='addEmployee-alignRow'>
              <div className='addEmployee-inputFieldDiv'>
                <label className='addEmployee-inputLabel'>Sequence <span style={{ color: "red", fontSize: "1.2rem" }}>*</span> </label>
                {/* <input
                  type='text'
                  name='title'
                  placeholder='Title'
                ...
                /> */}
                <select onChange={handleChange} name="sequence" id="" className='addEmployee-inputField'>
              ...
              <div className='addEmployee-inputFieldDiv'>
                ...
                <input
                  ...
                  className='addEmployee-inputField'
                  onChange={(e) => setGallaryData({ ...GallaryData, image: e.target.files[0] })}
                />
              </div>
            </div>
